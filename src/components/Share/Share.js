    ...
    <div className='share'>
        <div className="shareWrapper">
            <div className="shareTop">
                ...
                <input type="text" className="shareInput" placeholder='今何しているの？' ref={desc}/>
            </div>
            <hr className='shareHr'/>
            <form className="shareButtons" onSubmit={(e) => handleSubmit(e)}>
                <div className="shareOptions">
                    <label className="shareOption" htmlFor='file'> {/*labelにして、htmlForとinputのidを一致させることで、inputをクリックすることなくlabelをクリックするだけでinputを起動できる*/}
